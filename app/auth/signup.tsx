...
<Image
  ...
  resizeMode="contain"
/>
      <Text style={{ fontSize: 20, color: 'green', textAlign: 'center', fontWeight: 'bold', marginBottom: 30 }}>
...
<Pressable onPress={handleSignUp} style={styles.button}>
  <Text style={styles.buttonText}>Register</Text>
      ...
      <Text style={{ marginTop: 20, textAlign: 'center', color: '#808080' }}>Already have an account?</Text>
      <Pressable onPress={() => router.push('/auth/login')}>
        <Text style={{ textAlign: 'center', color: 'green', fontWeight: 'bold' }}>Login</Text>
      </Pressable>
